...
function initAll() {
	document.getElementById("imgText").innerHTML = captionText[0]; // algab indeksipositsioonilt 0
	document.getElementById("prevLink").onclick = processPrevious;
	document.getElementById("nextLink").onclick = processNext;
}

function processPrevious() { // M‰‰ravad liikumissuuna
	newSlide(-1);
}
...
function newSlide(direction) {
	...
	document.getElementById("slideshow").src = "images/slideImg" + currImg + ".jpg" //muudetakse pilt
	document.getElementById("imgText").innerHTML = captionText[currImg]  // ja vastavalt ka tekst
}
